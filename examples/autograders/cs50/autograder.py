#!/usr/bin/env python3
"""classroom50 + check50 autograder (org-level default).

Grades every CS50 problem set in this org by mapping the assignment
slug to a check50 spec under cs50/problems/<year>/x/<slug>. Each
assignment's slug must match its CS50 problem-set leaf name
(tideman, mario, cash, etc.). Pair with runtime.json (next to this
file) so check50, clang, libcs50, and the rest of the cs50 toolchain
are preinstalled.
